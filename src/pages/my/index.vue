    ...
    <view>
       ...
       <button open-type="openSetting">打开授权</button> -->
        <view class="user">
            ...
            <button v-if="!userInfo.nickName" class="weui-btn mini-btn" size="mini" type="default" open-type="getUserInfo" @getuserinfo="getuserinfo">授权登录</button>
        </view>
        <!-- 2.0 收藏相关 -->
